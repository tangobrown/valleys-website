    ...
    <>
      ...
      <section className="bg-white px-5 pt-[74px] sm:px-8">
        <div className="mx-auto max-w-[1040px] text-center">
          <h2 className="mb-[18px] font-display text-[30px] font-bold text-heading sm:text-[37px]">
            Protecting New Zealand Birdlife
          </h2>
          <p className="m-0 text-[16px] font-bold text-slate">
        ...
        <div className="mx-auto grid max-w-[940px] grid-cols-1 gap-[34px] md:grid-cols-3">
          {infoCards.map((card) => (
            ...
            >
              ...
              <h3 className="mb-[14px] font-display text-[22px] font-bold text-white">{card.title}</h3>
              <p className="mb-[26px] flex-1 text-[15px] leading-[1.6] text-cardbody">{card.body}</p>
              <Link
                href={card.href}
