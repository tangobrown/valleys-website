...
export default function TrappingPage() {
  return (
    <>
      ...
      >
        <p className="m-0 mt-4 max-w-[520px] text-[17px] font-bold leading-[1.55] text-white [text-shadow:0_1px_8px_rgba(0,0,0,0.45)]">
      ...
      <section className="bg-white px-5 pb-10 pt-[78px] sm:px-8">
        <div className="mx-auto grid max-w-[1040px] grid-cols-1 items-start gap-x-[60px] gap-y-[70px] md:grid-cols-2">
          ...
          <div>
            ...
            <p className="m-0 text-[17px] leading-[1.7] text-ink">
              <strong>Species Monitoring</strong> is directed by DOC. An initial survey of
